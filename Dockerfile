...
RUN apt-get update && DEBIAN_FRONTEND=noninteractive apt-get install -y unzip supervisor && wget -O emqttd.zip http://emqtt.io/static/brokers/emqttd-ubuntu64-0.13.0-beta-20151108.zip
